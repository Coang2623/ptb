...
export function AIStatusIndicator() {
    ...
    return (
        <div className="glass px-8 py-4 rounded-full flex gap-6 text-white/30 text-sm font-medium items-center">
            ...
            <div className="flex items-center gap-2">
                ...
                <span className={cn(
                    ...
                    {isSessionActive ? 'SESSION LIVE' : isOpenHandDetected ? 'MAGIC READY:握' : 'Sequence: 🖐️ → ✊'}
                </span>
            </div>
